/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0feb002b63e8785b758a329e52536853)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FITBIT_CLIENT_ID" | "FITBIT_CLIENT_SECRET">> {}
}
declare module "*.md" {
	const value: string;
